  ...
  if (view === 'menu') {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-100 to-blue-200 p-4">
        ...
        <div className="mt-8 text-center max-w-md bg-white p-6 rounded-xl shadow-md">
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-100 to-blue-200 p-4">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="mt-4">
          ...
          <p className="text-sm text-gray-500 text-center mt-2">ルームIDが分からない場合はこちらをお試しください</p>
        </div>
